...
input_data_path = Path("greece_case")
...
network_ship = pd.read_excel(path_files_node_flux/"node_metrics.xlsx", index_col=0, sheet_name='ship') # ship connection and distance




electricity_price = pd.read_csv(path_files_electricity/"electricity_prices_hourly_2023.csv") # electricity price
...
#----- Add networks -----#
new_network_types = ["CO2_Pipeline", "CO2Truck", "CO2Railway", "CO2Ship"]
